...
@onready var grid_container = $TextureRect/MarginContainer/VBoxContainer/ScrollContainer/GridContainer
@onready var item_scene = preload("res://scenes/item.tscn")
@onready var scroll_container = $TextureRect/MarginContainer/VBoxContainer/ScrollContainer
